...
from langchain.chains import ConversationalRetrievalChain, ChatMessageHistory
...
# Define the conversational retrieval chain with ChatGroq
conversational_retrieval_chain = ChatGroq(temperature=0, groq_api_key=GROQ_API_KEY, model_name="llama3-8b-8192")
